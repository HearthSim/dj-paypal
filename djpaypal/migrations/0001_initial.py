# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-31 18:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(editable=False, null=True)),
                ...
                ('dispute_outcome', django.contrib.postgres.fields.jsonb.JSONField(editable=False, null=True)),
                ('messages', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('seller_response_due_date', models.DateTimeField(editable=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('djpaypal_created', models.DateTimeField(auto_now_add=True)),
                ('djpaypal_updated', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(help_text='The most recent Django user that transacted as this Payer (best-effort).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='paypal_payers', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('cart', models.CharField(db_index=True, max_length=127, null=True)),
                ('payer', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('executed_agreement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='prepared_agreements', to='djpaypal.BillingAgreement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clearing_time', models.DateTimeField(editable=False, null=True)),
                ('transaction_fee', djpaypal.fields.CurrencyAmountField(editable=False, null=True)),
                ('receivable_amount', djpaypal.fields.CurrencyAmountField(editable=False, null=True)),
                ('exchange_rate', models.CharField(editable=False, max_length=64)),
                ('fmf_details', django.contrib.postgres.fields.jsonb.JSONField(editable=False, null=True)),
                ('receipt_id', models.CharField(db_index=True, editable=False, max_length=19)),
                ('processor_response', django.contrib.postgres.fields.jsonb.JSONField(editable=False, null=True)),
                ('create_time', models.DateTimeField(editable=False)),
                ('update_time', models.DateTimeField(editable=False)),
                ('billing_agreement', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='djpaypal.BillingAgreement')),
                ('parent_payment', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='djpaypal.Payment')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transmissions', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('webhook_event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='djpaypal.WebhookEvent')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='payer_model',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='djpaypal.Payer'),
        ),
        migrations.AddField(
            model_name='billingagreement',
            name='user',
